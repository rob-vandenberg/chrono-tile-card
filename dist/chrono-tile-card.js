        ...
        >
          ${!1!==t.show_icon?html`
            <ha-state-icon
              ...
              .stateObj=${e}
              .icon=${t.icon||void 0}
              style="--mdc-icon-size: calc(${t.icon_size??DEFAULT_ITEM.icon_size}px * var(--scale-factor, 1));"
            ></ha-state-icon>
          `:""}
