import{LitElement,html,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";import{styleMap}from"https://unpkg.com/lit@2.0.0/directives/style-map.js?module";import{unsafeHTML}from"https://unpkg.com/lit@2.0.0/directives/unsafe-html.js?module";import{repeat}from"https://unpkg.com/lit@2.0.0/directives/repeat.js?module";const CARD_VERSION="2.0.21",mdiDragHorizontalVariant="M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z";console.info("%c CHRONO-%cTILE%c-CARD %c v2.0.21 ","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 0 2px 4px; border-radius: 3px 0 0 3px;","background-color: #101010; color: #4676d3; font-weight: bold; padding: 2px 0;","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 4px 2px 0;","background-color: #1E1E1E; color: #FFFFFF; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");const DEFAULT_ITEM={_id:"",show:!0,horizontal:"center",vertical:"middle",icon:"",icon_size:24,show_icon:!0,show_state:!1,font_color:"#FFFFFF",font_family:"DSEG7 Classic",font_size:1,font_weight:400,line_height:"",border_radius:"",background_color:"",padding_horizontal:"",padding_vertical:"",margin_top:"",margin_bottom:"",text_shadow_color:"",text_shadow_blur:"",text_shadow_offset_x:"",text_shadow_offset_y:"",text_shadow_stroke_width:"",text_shadow_layers:2},DEFAULT_ENTITY_ITEM={...DEFAULT_ITEM,entity:""},DEFAULT_TEMPLATE_ITEM={...DEFAULT_ITEM,template:""},DEFAULT_ZONE_ALIGNMENT={"top-left":"left","top-center":"center","top-right":"right","middle-left":"left","middle-center":"center","middle-right":"right","bottom-left":"left","bottom-center":"center","bottom-right":"right"},DEFAULT_ZONE_OFFSET_X={"top-left":12,"top-center":0,"top-right":-12,"middle-left":12,"middle-center":0,"middle-right":-12,"bottom-left":12,"bottom-center":0,"bottom-right":-12},DEFAULT_ZONE_OFFSET_Y={"top-left":-12,"top-center":-12,"top-right":-12,"middle-left":0,"middle-center":0,"middle-right":0,"bottom-left":12,"bottom-center":12,"bottom-right":12},EDITOR_PREVIEW_ASPECT_RATIO="16 / 10";function isInsideEditDialog(t){let e=t;for(;e;){if("HA-DIALOG"===e.tagName)return!0;e=e.parentElement||e.getRootNode()?.host}return!1}const HOLD_MS=500,DOUBLE_TAP_MS=250,SWIPE_THRESHOLD=40,DEFAULT_CONFIG={background_color:"#000000",dimmer_enabled:!1,dimmer_entity:"",dimmer_lux_min:0,dimmer_lux_max:40,dimmer_opacity_min:0,dimmer_opacity_max:80,dimmer_color:"#000000",dimmer_aggressiveness:50,zone_alignment:{...DEFAULT_ZONE_ALIGNMENT},zone_offset_x:{...DEFAULT_ZONE_OFFSET_X},zone_offset_y:{...DEFAULT_ZONE_OFFSET_Y},items:[]},NUMERIC_ITEM_KEYS=new Set(["font_size","font_weight","line_height","border_radius","padding_horizontal","padding_vertical","margin_top","margin_bottom","text_shadow_blur","text_shadow_offset_x","text_shadow_offset_y","text_shadow_stroke_width"]),SHADOW_DEPENDENT_KEYS=new Set(["text_shadow_blur","text_shadow_offset_x","text_shadow_offset_y"]),VERTICAL_OPTIONS=[{label:"Top",value:"top"},{label:"Middle",value:"middle"},{label:"Bottom",value:"bottom"}],HORIZONTAL_OPTIONS=[{label:"Left",value:"left"},{label:"Center",value:"center"},{label:"Right",value:"right"}],ZONE_ALIGNMENT_OPTIONS=[{label:"Left",value:"left"},{label:"Center",value:"center"},{label:"Right",value:"right"}],FONT_OPTIONS=[{label:"Theme default",value:"",family:"",slug:"",italic:!1},{label:"DSEG14 Classic",value:"DSEG14 Classic",family:"DSEG14 Classic",slug:"dseg14-classic",italic:!1},{label:"DSEG14 Classic Italic",value:"DSEG14 Classic Italic",family:"DSEG14 Classic",slug:"dseg14-classic",italic:!0},{label:"DSEG7 Classic",value:"DSEG7 Classic",family:"DSEG7 Classic",slug:"dseg7-classic",italic:!1},{label:"DSEG7 Classic Italic",value:"DSEG7 Classic Italic",family:"DSEG7 Classic",slug:"dseg7-classic",italic:!0},{label:"Roboto",value:"Roboto",family:"Roboto",slug:"roboto",italic:!1},{label:"Open Sans",value:"Open Sans",family:"Open Sans",slug:"open-sans",italic:!1},{label:"Montserrat",value:"Montserrat",family:"Montserrat",slug:"montserrat",italic:!1},{label:"Poppins",value:"Poppins",family:"Poppins",slug:"poppins",italic:!1},{label:"Inter",value:"Inter",family:"Inter",slug:"inter",italic:!1},{label:"Oswald",value:"Oswald",family:"Oswald",slug:"oswald",italic:!1},{label:"Rajdhani",value:"Rajdhani",family:"Rajdhani",slug:"rajdhani",italic:!1},{label:"Orbitron",value:"Orbitron",family:"Orbitron",slug:"orbitron",italic:!1},{label:"Share Tech Mono",value:"Share Tech Mono",family:"Share Tech Mono",slug:"share-tech-mono",italic:!1},{label:"VT323",value:"VT323",family:"VT323",slug:"vt323",italic:!1},{label:"Press Start 2P",value:"Press Start 2P",family:"Press Start 2P",slug:"press-start-2p",italic:!1}],_FONT_OPTION_BY_VALUE=new Map(FONT_OPTIONS.map(t=>[t.value,t])),_injectedFonts=new Set;function ensureFontLoaded(t){if(!t||_injectedFonts.has(t))return;const e=_FONT_OPTION_BY_VALUE.get(t);if(!e?.slug)return;_injectedFonts.add(t);const i=e.italic?"400-italic.css":"400.css",o=document.createElement("link");o.rel="stylesheet",o.href=`https://cdn.jsdelivr.net/npm/@fontsource/${e.slug}/${i}`,document.head.appendChild(o)}const SHOW_ITEM_POSITION_BADGES=!1,VERTICAL_BADGE_COLORS={top:"#ac00ac",middle:"#c77c00",bottom:"#0600ff"},HORIZONTAL_BADGE_COLORS={left:"#bb9e00",center:"#10a800",right:"#00a896"},GROUP_DIVIDER_COLOR="#009ac7",_GROUP_DEFS=[{vertical:"top",horizontal:"left",label:"Top · Left"},{vertical:"top",horizontal:"center",label:"Top · Center"},{vertical:"top",horizontal:"right",label:"Top · Right"},{vertical:"middle",horizontal:"left",label:"Middle · Left"},{vertical:"middle",horizontal:"center",label:"Middle · Center"},{vertical:"middle",horizontal:"right",label:"Middle · Right"},{vertical:"bottom",horizontal:"left",label:"Bottom · Left"},{vertical:"bottom",horizontal:"center",label:"Bottom · Center"},{vertical:"bottom",horizontal:"right",label:"Bottom · Right"}],_GROUP_ORDER=_GROUP_DEFS.map(t=>`${t.vertical}-${t.horizontal}`);function sortItems(t){const e=t=>`${t.vertical??"middle"}-${t.horizontal??"center"}`;return[...t].sort((t,i)=>_GROUP_ORDER.indexOf(e(t))-_GROUP_ORDER.indexOf(e(i)))}function generateId(t=[]){const e=new Set(t.map(t=>t._id));let i;do{i=Math.random().toString(16).slice(2,10)}while(e.has(i));return i}function migrateConfig(t){let e=!1;if(t.items?.some(t=>!t._id)){const i=[];for(const e of t.items)i.push(e._id?e:{...e,_id:generateId(t.items.concat(i))});t={...t,items:i},e=!0}const i=t.zone_alignment??{};Object.keys(DEFAULT_ZONE_ALIGNMENT).some(t=>!(t in i))&&(t={...t,zone_alignment:{...DEFAULT_ZONE_ALIGNMENT,...i}},e=!0);const o=t.zone_offset_x??{};Object.keys(DEFAULT_ZONE_OFFSET_X).some(t=>!(t in o))&&(t={...t,zone_offset_x:{...DEFAULT_ZONE_OFFSET_X,...o}},e=!0);const n=t.zone_offset_y??{};return Object.keys(DEFAULT_ZONE_OFFSET_Y).some(t=>!(t in n))&&(t={...t,zone_offset_y:{...DEFAULT_ZONE_OFFSET_Y,...n}},e=!0),{config:t,migrated:e}}function fireEvent(t,e,i={},o={}){const n=new Event(e,{bubbles:o.bubbles??!0,cancelable:Boolean(o.cancelable),composed:o.composed??!0});return n.detail=i,t.dispatchEvent(n),n}function navigate(t,e={}){e.replace?history.replaceState(null,"",t):history.pushState(null,"",t),fireEvent(window,"location-changed",{replace:e.replace??!1})}function toggleEntity(t,e){e&&t.callService("homeassistant","toggle",{entity_id:e})}function handleAction(t,e,i,o){let n;switch("double_tap"===o&&i.double_tap_action?n=i.double_tap_action:"hold"===o&&i.hold_action?n=i.hold_action:"tap"===o&&i.tap_action?n=i.tap_action:"tap"===o&&i.entity?n={action:"more-info"}:"swipe_up"===o&&i.swipe_up_action?n=i.swipe_up_action:"swipe_down"===o&&i.swipe_down_action?n=i.swipe_down_action:"swipe_left"===o&&i.swipe_left_action?n=i.swipe_left_action:"swipe_right"===o&&i.swipe_right_action&&(n=i.swipe_right_action),n||(n={action:"none"}),n.action){case"none":default:break;case"more-info":fireEvent(t,"hass-more-info",{entityId:n.entity??i.entity});break;case"navigate":n.navigation_path&&navigate(n.navigation_path,{replace:n.navigation_replace});break;case"url":n.url_path&&window.open(n.url_path,"_blank");break;case"toggle":toggleEntity(e,i.entity);break;case"perform-action":case"call-service":{const t=n.perform_action??n.service;if(!t)break;const[i,o]=t.split(".",2);if(!i||!o)break;e.callService(i,o,n.data??n.service_data,n.target);break}case"fire-dom-event":fireEvent(t,"ll-custom",n)}}const pxValue=t=>""!==t&&null!=t?`${t}px`:void 0,emValue=t=>""!==t&&null!=t?`${t}em`:void 0,rawValue=t=>""!==t&&null!=t?`${t}`:void 0,_TEMPLATE_EXPR_RE=/\{\{(.*?)\}\}/gs,_IDENTIFIER_RE=/[A-Za-z_][A-Za-z0-9_]*/g;function _jinjaLiteral(t){if(null==t)return"''";const e=String(t);return""===e?"''":/^-?\d+(\.\d+)?$/.test(e)||"true"===e||"false"===e?e:`'${e.replace(/\\/g,"\\\\").replace(/'/g,"\\'")}'`}function substituteCardVariables(t,e){const i=String(t??"");if(!i.includes("{{")||!e)return{text:i,fullyLiteral:!i.includes("{{")};let o=!0;const n=[];i.replace(_TEMPLATE_EXPR_RE,(t,i)=>{const r=i.trim(),s=/^[A-Za-z_][A-Za-z0-9_]*$/.test(r)&&Object.prototype.hasOwnProperty.call(e,r);return s||(o=!1),n.push({inner:i,isCardField:s,field:s?r:null}),t});let r=0;if(o){return{text:i.replace(_TEMPLATE_EXPR_RE,()=>{const{field:t}=n[r++],i=e[t];return null==i?"":String(i)}),fullyLiteral:!0}}return{text:i.replace(_TEMPLATE_EXPR_RE,(t,i)=>`{{${i.replace(_IDENTIFIER_RE,t=>Object.prototype.hasOwnProperty.call(e,t)?_jinjaLiteral(e[t]):t)}}}`),fullyLiteral:!1}}function ctParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(""===e)return"";const i=parseFloat(e);return isNaN(i)||String(i)!==e?null:i}function ctTextField(t,e,i,o={}){return html`
        ...
        <ha-sortable handle-selector=".handle" @item-moved=${t=>this._itemMoved(t)}>
          <div class="items-list">
            ${repeat(e,t=>t.key,t=>{if("divider"===t.type)return html`
                ...
                `;const e=t.item,i=t.itemIndex,o="entity"in e,n=o?"Entity":"Template",r=o?"entity":"template",s=o?e.entity||`Entity ${i+1}`:e.template?e.template.length>30?e.template.slice(0,30)+"…":e.template:`Template ${i+1}`;return html`
                <ha-expansion-panel
                  outlined
                  data-item-id="${e._id}"
                ...
                >
                  ...
                  ${o?html`
                    <div class="item-icon-row">
                      ...
                      ${ctTextField("Icon size",e.icon_size??"",t=>this._itemChanged(i,"icon_size",t),{type:"number",step:"1",min:"0"})}
                    </div>
                  `:""}
                  ...
                  ${o?html`
                    <div class="item-toggles-row">
                      ${ctToggleField("Show icon",e.show_icon??!0,t=>this._itemToggled(i,"show_icon",t))}
  ...
  `;render(){if(!this._config)return html``;const t=this._config;return html`
    ...
    `}}customElements.define("chrono-tile-card-editor",ChronoTileCardEditor);class ChronoTileCard extends LitElement{static properties={_config:{attribute:!1},_itemValues:{state:!0}};static getCardSize(){return 3}getGridOptions(){const t=this._config?.items??[],e=new Set(t.filter(t=>!1!==t.show).map(t=>t.vertical??"middle")).size;return{rows:Math.max(2,2*e),min_rows:2,columns:12}}static getConfigElement(){return document.createElement("chrono-tile-card-editor")}static getStubConfig(){return{...DEFAULT_CONFIG,items:[{...DEFAULT_TEMPLATE_ITEM,_id:generateId([]),show:!0,horizontal:"center",vertical:"middle",icon:"",show_state:!1,font_color:"#808080",font_size:12,font_weight:400,line_height:1.2,border_radius:50,background_color:"",padding_vertical:10,padding_horizontal:10,margin_top:"",margin_bottom:"",text_shadow_color:"",text_shadow_blur:0,text_shadow_offset_x:0,text_shadow_offset_y:0,text_shadow_stroke_width:0,text_shadow_layers:2,template:"{{ now().strftime('%H:%M') }}"}]}}constructor(){super(),this._config=null,this._hass=null,this._itemValues={},this._itemSubs=new Map,this._subscribed=!1,this._holdTimer=null,this._holdFired=!1,this._lastTapTime=0,this._lastTapTarget=null,this._pendingTapTimer=null,this._touchStartX=null,this._touchStartY=null,this._pressedItem=null}set hass(t){const e=this._hass;this._hass=t,this._config&&this._setupSubscriptions(),this._hassShouldRender(e,t)&&this.requestUpdate()}get hass(){return this._hass}_hassShouldRender(t,e){if(!t||!e)return!0;const i=this._config;if(!i)return!0;if(t.locale!==e.locale||t.formatEntityState!==e.formatEntityState)return!0;const o=new Set;i.dimmer_entity&&o.add(i.dimmer_entity);for(const t of i.items??[])t.entity&&o.add(t.entity);for(const i of o)if(t.states?.[i]!==e.states?.[i])return!0;return!1}setConfig(t){({config:t}=migrateConfig(t)),this._config=t,this._hass&&this._setupSubscriptions()}connectedCallback(){super.connectedCallback(),this._hass&&this._config&&!this._subscribed&&this._setupSubscriptions(),this.style.setProperty("--editor-preview-aspect-ratio",isInsideEditDialog(this)?"16 / 10":"auto"),this.style.setProperty("--editor-preview-height",isInsideEditDialog(this)?"auto":"100%")}disconnectedCallback(){super.disconnectedCallback(),this._teardownSubscriptions()}_setupSubscriptions(){this._itemSubs||(this._itemSubs=new Map);const t=this._config?.items??[],e=this._config??{},i=new Set,o=t=>t.replace(/_([a-z])/g,(t,e)=>e.toUpperCase()),n={},r=new Set(["zone_alignment","items"]);for(const t of Object.keys(DEFAULT_CONFIG)){if(r.has(t))continue;const i="card"+o(t).replace(/^./,t=>t.toUpperCase());n[i]=e[t]??DEFAULT_CONFIG[t]}n.cardDimmerOpacity=Math.round(1e3*this._computeDimmerOpacity())/10,t.forEach((t,e)=>{if(!("template"in t))return;const o=`item-${e}`;i.add(o);const{text:r,fullyLiteral:s}=substituteCardVariables(t.template??"",n),a=this._itemSubs.get(o);if(a&&a.substituted===r)return;if(a?.unsub&&this._unsubscribeOne(a.unsub),s)return this._itemValues={...this._itemValues,[o]:r},void this._itemSubs.set(o,{substituted:r,unsub:null});const l=this._hass.connection.subscribeMessage(t=>{this._itemValues={...this._itemValues,[o]:t.result}},{type:"render_template",template:r});this._itemSubs.set(o,{substituted:r,unsub:l})});for(const[t,e]of[...this._itemSubs.entries()])if(!i.has(t)){e.unsub&&this._unsubscribeOne(e.unsub),this._itemSubs.delete(t);const{[t]:i,...o}=this._itemValues;this._itemValues=o}this._subscribed=!0}_unsubscribeOne(t){Promise.resolve(t).then(t=>{"function"==typeof t&&t()}).catch(()=>{})}_teardownSubscriptions(){if(this._itemSubs){for(const t of this._itemSubs.values())t.unsub&&this._unsubscribeOne(t.unsub);this._itemSubs.clear()}this._subscribed=!1}_handleAction(t,e="tap"){this._hass&&handleAction(this,this._hass,t,e)}_resolveActionItem(t){const e=t.target.closest?.("[data-item-index]");if(!e)return null;const i=Number(e.getAttribute("data-item-index"));return this._config.items?.[i]??null}_onPointerDown(t){t.currentTarget.setPointerCapture(t.pointerId),this._pressedItem=this._resolveActionItem(t),this._touchStartX=t.clientX,this._touchStartY=t.clientY,this._holdFired=!1,this._holdTimer&&clearTimeout(this._holdTimer),this._holdTimer=setTimeout(()=>{this._holdFired=!0,this._handleAction(this._pressedItem??this._config,"hold")},500)}_onPointerUp(t){if(null===this._touchStartX)return;const e=t.clientX-this._touchStartX,i=t.clientY-this._touchStartY,o=this._pressedItem;this._touchStartX=null,this._touchStartY=null,this._pressedItem=null,this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=null);const n=Math.abs(e)>=40&&Math.abs(e)>=Math.abs(i),r=Math.abs(i)>=40&&Math.abs(i)>Math.abs(e);if(n)return void(this._holdFired||this._handleAction(this._config,e<0?"swipe_left":"swipe_right"));if(r)return void(this._holdFired||this._handleAction(this._config,i<0?"swipe_up":"swipe_down"));if(this._holdFired)return;const s=o??this._config,a=Date.now();if(a-this._lastTapTime<250&&this._lastTapTarget===s)return this._lastTapTime=0,this._lastTapTarget=null,this._pendingTapTimer&&(clearTimeout(this._pendingTapTimer),this._pendingTapTimer=null),void this._handleAction(s,"double_tap");this._lastTapTime=a,this._lastTapTarget=s,this._pendingTapTimer&&clearTimeout(this._pendingTapTimer),this._pendingTapTimer=setTimeout(()=>{this._pendingTapTimer=null,this._handleAction(s,"tap")},250)}_onPointerCancel(){this._touchStartX=null,this._touchStartY=null,this._pressedItem=null,this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=null)}_onPointerMove(t){if(null===this._touchStartX||!this._holdTimer)return;const e=t.clientX-this._touchStartX,i=t.clientY-this._touchStartY;(Math.abs(e)>=40||Math.abs(i)>=40)&&(clearTimeout(this._holdTimer),this._holdTimer=null)}_computeDimmerOpacity(){const t=this._config,e=t.dimmer_entity??"";if(!e)return 0;const i=this._hass?.states?.[e],o=i?parseFloat(i.state):0;if(isNaN(o))return 0;const n=t.dimmer_lux_min??DEFAULT_CONFIG.dimmer_lux_min,r=t.dimmer_lux_max??DEFAULT_CONFIG.dimmer_lux_max,s=(t.dimmer_opacity_min??DEFAULT_CONFIG.dimmer_opacity_min)/100,a=(t.dimmer_opacity_max??DEFAULT_CONFIG.dimmer_opacity_max)/100,l=t.dimmer_aggressiveness??DEFAULT_CONFIG.dimmer_aggressiveness,c=Math.pow(10,(l-50)/50);if(r<=n)return a;const d=Math.max(0,Math.min(1,(o-n)/(r-n)));return a+(s-a)*Math.pow(d,.33*c)}_itemContainerStyleMap(t){return{"border-radius":pxValue(t.border_radius),"background-color":t.background_color||void 0,"padding-top":pxValue(t.padding_vertical),"padding-bottom":pxValue(t.padding_vertical),"padding-left":pxValue(t.padding_horizontal),"padding-right":pxValue(t.padding_horizontal),"margin-top":pxValue(t.margin_top),"margin-bottom":pxValue(t.margin_bottom)}}_itemTextStyleMap(t){const e=_FONT_OPTION_BY_VALUE.get(t.font_family);return{color:t.font_color||void 0,"font-family":(e?e.family:t.font_family)||void 0,"font-style":e?.italic?"italic":void 0,"font-size":emValue(t.font_size),"font-weight":rawValue(t.font_weight),"line-height":rawValue(t.line_height),"text-shadow":t.text_shadow_color&&""!==t.text_shadow_offset_x&&""!==t.text_shadow_offset_y?Array(Math.max(1,Number(t.text_shadow_layers??2)||1)).fill(`${pxValue(t.text_shadow_offset_x??0)} ${pxValue(t.text_shadow_offset_y??0)} ${pxValue(t.text_shadow_blur??0)} ${t.text_shadow_color}`).join(", "):void 0,"-webkit-text-stroke-width":t.text_shadow_color?pxValue(t.text_shadow_stroke_width??0):void 0,"-webkit-text-stroke-color":t.text_shadow_color||void 0}}_itemIsActionable(t,e){const i=t.tap_action?.action;return(e||!!i)&&"none"!==i}_renderItem(t){if(!1===t.show)return html``;ensureFontLoaded(t.font_family);const e=this._config.items.indexOf(t);if("template"in t){const i=`item-${e}`,o=this._itemValues[i]??"",n=this._itemIsActionable(t,!1);return html`
        <span
          class="overlay-template-item${n?" clickable":""}"
          data-item-index="${e}"
          style=${styleMap({...this._itemContainerStyleMap(t),...this._itemTextStyleMap(t)})}
        >${o}</span>
      `}if("entity"in t){const i=this._hass?.states?.[t.entity],o=this._itemContainerStyleMap(t),n=this._itemTextStyleMap(t);if(!i)return html`
          <div
            class="overlay-entity-item overlay-entity-missing"
            data-item-index="${e}"
            style=${styleMap(o)}
            title="Entity not found: ${t.entity}"
          >
            <span class="entity-state-label" style=${styleMap(n)}>!</span>
          </div>
        `;const r=t.show_state?t.attribute?`${t.prefix??""}${i.attributes?.[t.attribute]??""}${t.suffix??""}`:this._hass?.formatEntityState?this._hass.formatEntityState(i):i.state:"",s=this._itemIsActionable(t,!0);return html`
        <div
          class="overlay-entity-item${s?" clickable":""}"
          data-item-index="${e}"
          style=${styleMap(o)}
          title="${i.attributes.friendly_name??t.entity}: ${i.state}"
        >
          ${!1!==t.show_icon?html`
            <ha-state-icon
              .hass=${this._hass}
              .stateObj=${i}
              .icon=${t.icon||void 0}
              style="--mdc-icon-size: ${t.icon_size??DEFAULT_ITEM.icon_size}px; color: ${t.font_color||"inherit"};"
            ></ha-state-icon>
          `:""}
          ${t.show_state?html`<span class="entity-state-label" style=${styleMap(n)}>${r}</span>`:""}
        </div>
